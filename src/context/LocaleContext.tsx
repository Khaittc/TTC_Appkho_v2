...
export const translations = {
  vi: {
    ...
    'items.deleteDisabledTooltip': 'Xóa vật tư — chức năng chưa được kích hoạt',

    // Item Detail Modal
    'itemDetail.titleView': 'Chi tiết vật tư: {model}',
    'itemDetail.titleEdit': 'Chỉnh sửa vật tư: {model}',
    ...
    'itemDetail.description': 'Mô tả',
    'itemDetail.mpn': 'Mã sản phẩm NSX (MPN)',
    ...
    'itemDetail.safetyStock': 'Tồn kho an toàn',
    'itemDetail.datasheetUrl': 'Tài liệu kỹ thuật',
    'itemDetail.openDocument': 'Mở tài liệu',
    ...
    'suppliers.removeFromItem': 'Gỡ khỏi vật tư',
    'suppliers.removeFromItemTooltip': 'Gỡ khỏi vật tư — chức năng chưa được kích hoạt',
  ...
  en: {
    ...
    'items.deleteDisabledTooltip': 'Delete item — functionality is not enabled yet',

    // Item Detail Modal
    'itemDetail.titleView': 'Item Details: {model}',
    'itemDetail.titleEdit': 'Edit Item: {model}',
    ...
    'itemDetail.datasheetUrl': 'Technical Document',
    'itemDetail.openDocument': 'Open document',
    'itemDetail.technicalNote': 'Technical Notes',
    ...
    'suppliers.removeFromItem': 'Remove from item',
    'suppliers.removeFromItemTooltip': 'Remove from item — functionality is not enabled yet',
