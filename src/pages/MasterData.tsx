            ...
            <form onSubmit={handleAddUnit} className="space-y-5">
              <div>
                ...
                <input 
                  ...
                  className="w-full rounded-lg border border-slate-300 px-3 py-2 text-sm focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 focus:outline-none transition-colors max-w-md" 
                />
              </div>
              <div className="flex justify-end gap-2 pt-2 border-t border-slate-100">
                <button 
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                <div>
                  ...
                  <input 
                    type="text" 
                    value={supZalo} 
                    onChange={e=>setSupZalo(e.target.value)} 
                    className="w-full rounded-lg border border-slate-300 px-3 py-2 text-sm focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 focus:outline-none transition-colors" 
                  />
                </div>
          ...
          {activeTab === 'PROJECTS' && (
            <form onSubmit={handleSubmitProject} className="space-y-5">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <label className="block text-sm font-medium text-slate-700 mb-1">
                    Mã DA <span className="text-red-500">*</span>
                  </label>
                  <input 
                    required 
                    type="text" 
